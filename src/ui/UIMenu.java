...
public class UIMenu {
    ...
    private static void authUser(int userType){
        ...
        doctors.add(new Doctor("Alejandro Martinez", "alenadro@gmail.com"));
        doctors.add(new Doctor("Karen Sosa", "karen@gmail.com"));
        doctors.add(new Doctor("Rocio Gomez", "rocio@gmail.com"));

        ArrayList<Patient> patients = new ArrayList<>();
        patients.add(new Patient("Anahi Salgado", "ana@gmail.com"));
        patients.add(new Patient("Roberto Rodrigez", "roberto@gmail.com"));
        patients.add(new Patient("Carloz Sanchez", "carlos@gmail.com"));

        boolean emailCorrect = false;
        do {
            System.out.println("Insert yout email");
            Scanner sc = new Scanner(System.in);
